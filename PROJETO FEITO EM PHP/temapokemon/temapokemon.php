...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="temapokemon.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
    <title>Pokemon 1°GEN</title>
</head>
<body>
    <div class="container">
      ...
      <div id="imageContainer">
        ...
        <div id="pokemon1" class="pokemonContainer" onclick="selectOption('this')">
          <img id="image1" class="pokemonImage" />
          <div id="name1" class="pokemonName"></div>
        </div>

        <div id="pokemon2" class="pokemonContainer" onclick="selectOption('that')">
          <img id="image2" class="pokemonImage" />
          <div id="name2" class="pokemonName"></div>
        </div>
      </div>
    ...
    <script src="temapokemon.js"></script>
</body>